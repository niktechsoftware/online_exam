...
<head>
   ...
   <title>Page Contact | Materialize - Material Design Admin Template</title>
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/pages/page-contact.css">
   <!-- END: Page Level CSS-->
   <!-- BEGIN: Custom CSS-->
