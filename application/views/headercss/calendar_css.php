...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/vendors/fullcalendar/css/fullcalendar.min.css">
   <!-- END: VENDOR CSS-->
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/pages/app-calendar.css">
   <!-- END: Page Level CSS-->
   <!-- BEGIN: Custom CSS-->
