                      ...
                      <div class="panel panel-calendar  exam_panel_body">
                        ...
                        <div class="panel-body">
                          <div class="text-black text-large exam_panel">
                            ...
                            <div class="alert alert-warning"> Type a Test name ,description and its marks ,and press Add Test Name.If All details are added
                      ...
                      <div class="panel panel-calendar  exam_panel_body">
                        ...
                        <div class="panel-body">
                          ...
                          <div class="form-group">
                            ...
                            <!--<br--><!-- <br><br> -->
                            <div class="alert alert-warning"> Type a <strong>Subject Name and Question No.</strong>  and press Add Subject Button.If Subject Name and Question No. added successfully then it show in right side panel where you can change the all detail and Delete it.
                            </div>
                          </div>
                        </div>
                      </div>
